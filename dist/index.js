...
mongoose_1.default.connect('mongodb+srv://Pecture:Patatas2019@pecture-qsesc.mongodb.net/test?retryWrites=true&w=majority', { useNewUrlParser: true, useCreateIndex: true }, (err) => {
    if (err)
        throw err;
